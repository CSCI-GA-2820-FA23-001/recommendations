...
import logging
import unittest
from service.models import Recommendation, DataValidationError, db, RecommendationStatus, RecommendationType
...
class TestRecommendation(unittest.TestCase):
    ...
    def test_create_recommendation(self):
        ...
        self.assertEqual(recommendation.recommendation_id, None)
        self.assertEqual(recommendation.source_item_id, 123)
        self.assertEqual(recommendation.target_item_id, 456)
        self.assertEqual(recommendation.recommendation_type, RecommendationType.UP_SELL.name)
